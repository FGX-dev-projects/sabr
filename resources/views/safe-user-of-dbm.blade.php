...
<section class="relative w-full pb-[80px]">
    <div style="" class="wrapper  pb-[30px] ">
        ...
        <p class="text-center  font-[300] font-inter my-6"><a class="underline cursor-pointer text-blue-600 pb-5" target="_blank" href="{{ asset('images/SABR_WorkAid_PromotingTheSafeUse201806.pdf') }}">Download</a> the "SABR: Promoting the Safe Use of Donor Milk" PDF document (703Kb)</p>
    </div>
