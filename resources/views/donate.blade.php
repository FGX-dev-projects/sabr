@extends('layouts.app')
@section('title', 'SABR: South African Breastmilk Reserve - Donate')
...
@section('content')
                ...
                <div class="w-full h-full flex flex-col     gap-6">
                    <div class="w-full h-full flex flex-col text-[#107BA2]   gap-0">
                        ...
                        <p class="text-[20px] font-inter font-light">
                            Thank you for wanting to become a breastmilk donor. Ideal candidates are in good health and have
                            access to a fridge and freezer. There is no financial compensation but by filling out this form
                            you are on your way to helping an infant in need. We can’t thank you enough.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="w-full p- ">
                ...
                <form action="{{ route('donate.submit') }}" class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-12"
                    ...
                    <div>
                        ...
                        <input type="text" name="mother_alternative_number"
                            class="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    ...
                    <div class="dob-container">
                        ...
                        <div class="flex gap-2">
                            ...
                            <select name="mother_dob_day" id="mother_dob_day"
                                class="dob-date w-1/3 p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                            ...
                            <!-- Month Dropdown -->
                            <select name="mother_dob_month" id="mother_dob_month"
                                class="w-1/3 p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                            ...
                            <!-- Year Dropdown -->
                            <select name="mother_dob_year" id="mother_dob_year"
                                class="w-1/3 p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-5 gap-1">
                            <label for="mother_race_black" class="flex items-center gap-2">
                                <input type="radio" id="mother_race_black" name="mother_race" value="Black"
                                    class="form-radio scale-150 text-blue-500"> Black
                            </label>
                            <label for="mother_race_white" class="flex items-center gap-2">
                                <input type="radio" id="mother_race_white" name="mother_race" value="White"
                                    class="form-radio scale-150 text-blue-500"> White
                            </label>
                            <label for="mother_race_coloured" class="flex items-center gap-2">
                                <input type="radio" id="mother_race_coloured" name="mother_race" value="Coloured"
                                    class="form-radio scale-150 text-blue-500"> Coloured
                            </label>
                            <label for="mother_race_indian" class="flex items-center gap-2">
                                <input type="radio" id="mother_race_indian" name="mother_race" value="Indian"
                                    class="form-radio scale-150 text-blue-500"> Indian
                            </label>
                            <label for="mother_race_asian" class="flex items-center gap-2">
                                <input type="radio" id="mother_race_asian" name="mother_race" value="Asian"
                                    class="form-radio scale-150 text-blue-500"> Asian
                            </label>
                        </div>
                    </div>
                    ...
                    <h2 class="text-[32px] font-inter font-bold text-[#adaaa5] col-span-1 md:col-span-2">Occupational
                        Details</h2>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            <label for="volunteer_yes" class="flex items-center gap-2">
                                <input type="radio" id="volunteer_yes" name="volunteer" value="Yes"
                                    class="form-radio scale-150 text-blue-500"> Yes
                            </label>
                            <label for="volunteer_no" class="flex items-center gap-2">
                                <input type="radio" id="volunteer_no" name="volunteer" value="No"
                                    class="form-radio scale-150 text-blue-500"> No
                            </label>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input name="baby_name" type="text"
                            class="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>

                    <div>
                        <label for="baby_surname" class="block text-gray-600">Surname</label>
                        <input name="baby_surname" type="text"
                            class="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    ...
                    <div class="dob-container">
                        ...
                        <div class="flex gap-2">
                            <!-- Day Dropdown -->
                            <select name="baby_dob_day" id="baby_dob_day"
                                class="dob-date w-1/3 p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <option value="">Date</option>
                                @for ($i = 1; $i <= 31; $i++)
                                    <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}">{{ $i }}</option>
                            ...
                            <!-- Month Dropdown -->
                            <select name="baby_dob_month" id="baby_dob_month"
                                class="w-1/3 p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <option value="">Month</option>
                                @for ($i = 1; $i <= 12; $i++)
                                    <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}">
                            ...
                            <!-- Year Dropdown -->
                            <select name="baby_dob_year" id="baby_dob_year"
                                class="w-1/3 p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <option value="">Year</option>
                                @for ($i = date('Y'); $i >= 1900; $i--)
                                    <option value="{{ $i }}">{{ $i }}</option>
                    ...
                    <div>
                        ...
                        <input name="family_doctor_name" type="text"
                            class="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    <div>
                        <label for="family_doctor_number" class="block text-gray-600">Contact Number of Family
                            Doctor</label>
                        <input name="family_doctor_number" type="text"
                            class="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>


                    <h2 class="text-[32px] font-inter font-bold text-[#adaaa5] col-span-1 md:col-span-2">Declarations &
                        Consent</h2>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <label for="collect_info_no" class="flex items-center gap-2">
                                <input type="radio" id="collect_info_no" name="collect_info" value="No"
                                    class="form-radio scale-150 text-blue-500"> No
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <label for="share_info_no" class="flex items-center gap-2">
                                <input type="radio" id="share_info_no" name="share_info" value="No"
                                    class="form-radio scale-150 text-blue-500"> No
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <label for="truth_info_no" class="flex items-center gap-2">
                                <input type="radio" id="truth_info_no" name="truth_info" value="No"
                                    class="form-radio scale-150 text-blue-500"> No
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <label for="keep_records_no" class="flex items-center gap-2">
                                <input type="radio" id="keep_records_no" name="keep_records" value="No"
                                    class="form-radio scale-150 text-blue-500"> No
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <label for="cooler_box_no" class="flex items-center gap-2">
                                <input type="radio" id="cooler_box_no" name="cooler_box" value="No"
                                    class="form-radio scale-150 text-blue-500"> No
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-3">
                        <label class="block text-gray-600">I agree that the SABR cannot be held responsible for any
                            lactation-related advice that was requested from or given by a 3rd party</label>
                        <div class="flex gap-4">
                            <label for="lactation_advice_yes" class="flex items-center gap-2">
                                <input type="radio" id="lactation_advice_yes" name="lactation_advice" value="Yes"
                                    class="form-radio scale-150 text-blue-500"> Yes
                            </label>
                            <label for="lactation_advice_no" class="flex items-center gap-2">
                                <input type="radio" id="lactation_advice_no" name="lactation_advice" value="No"
                                    class="form-radio scale-150 text-blue-500"> No
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <label class="flex items-center gap-2">
                                <input type="radio" id="hiv_test_no" name="hiv_test" value="no"
                                    class="form-radio scale-150 text-blue-500"> No
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <label class="flex items-center gap-2">
                                <input type="radio" id="confidentiality_no" name="confidentiality" value="no"
                                    class="form-radio scale-150 text-blue-500"> No
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <label class="flex items-center gap-2">
                                <input type="radio" id="withdraw_consent_no" name="withdraw_consent" value="no"
                                    class="form-radio scale-150 text-blue-500"> No
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <label class="flex items-center gap-2">
                                <input type="radio" id="hiv_info_no" name="hiv_info" value="no"
                                    class="form-radio scale-150 text-blue-500"> No
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <label class="flex items-center gap-2">
                                <input type="radio" id="info_declined_no" name="info_declined" value="no"
                                    class="form-radio scale-150 text-blue-500"> No
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <label class="flex items-center gap-2">
                                <input type="radio" id="questions_opportunity_no" name="questions_opportunity" value="no"
                                    class="form-radio scale-150 text-blue-500"> No
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <label class="flex items-center gap-2">
                                <input type="radio" id="questions_answered_no" name="questions_answered" value="no"
                                    class="form-radio scale-150 text-blue-500"> No
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <label class="flex items-center gap-2">
                                <input type="radio" id="antenatal_results_no" name="antenatal_results" value="no"
                                    class="form-radio scale-150 text-blue-500"> No
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <label class="flex items-center gap-2">
                                <input type="radio" id="breastmilk_testing_no" name="breastmilk_testing" value="no"
                                    class="form-radio scale-150 text-blue-500"> No
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <label class="flex items-center gap-2">
                                <input type="radio" id="qhard_liquor_no" name="hard_liquor" value="no"
                                    class="form-radio scale-150 text-blue-500"> No
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <label class="flex items-center gap-2">
                                <input type="radio" id="vegetarian_no" name="vegetarian" value="no"
                                    class="form-radio scale-150 text-blue-500"> No
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-3">
                        <label for="b12vitamins_yes" class="block text-gray-600">If yes, do you supplement your diet with
                            B12 vitamins?</label>
                        <div class="flex gap-4">
                            <label class="flex items-center gap-2">
                                <input type="radio" id="b12vitamins_yes" name="b12vitamins" value="yes"
                                    class="form-radio scale-150 text-blue-500"> Yes
                            </label>
                            <label class="flex items-center gap-2">
                                <input type="radio" id="b12vitamins_no" name="b12vitamins" value="no"
                                    class="form-radio scale-150 text-blue-500"> No
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <label class="flex items-center gap-2">
                                <input type="radio" id="tobacco_no" name="tobacco" value="no"
                                    class="form-radio scale-150 text-blue-500"> No
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <label class="flex items-center gap-2">
                                <input type="radio" id="cannabis_no" name="cannabis" value="no"
                                    class="form-radio scale-150 text-blue-500"> No
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <label class="flex items-center gap-2">
                                <input type="radio" id="prescribed_medication_no" name="prescribed_medication" value="no"
                                    class="form-radio scale-150 text-blue-500"> No
                            </label>
                        </div>
                    </div>
                    <h2 class="text-[32px] font-inter font-bold text-[#adaaa5] col-span-1 md:col-span-2">Prescribed
                        medicines</h2>
                    <div class="col-span-1 md:col-span-2 flex flex-col gap-2 rounded-lg w-full">
                        <div class="flex flex-wrap gap-2">
                            <label for="antidepressants" class="flex items-center gap-2">
                                <input type="checkbox" id="antidepressants" name="prescribed_medicines[]"
                                    value="Antidepressants" class="form-checkbox text-blue-500 w-5 h-5">
                                Anti depressants
                            </label>
                            <label for="antihypertensives" class="flex items-center gap-2">
                                <input type="checkbox" id="antihypertensives" name="prescribed_medicines[]"
                                    value="Anti Hypertensives" class="form-checkbox text-blue-500 w-5 h-5">
                                Anti hypertensives
                            </label>
                            <label for="antibiotics" class="flex items-center gap-2">
                                <input type="checkbox" id="antibiotics" name="prescribed_medicines[]" value="Antibiotics"
                                    class="form-checkbox text-blue-500 w-5 h-5">
                                Antibiotics
                            </label>
                            <label for="anticoagulants" class="flex items-center gap-2">
                                <input type="checkbox" id="anticoagulants" name="prescribed_medicines[]"
                                    value="Anticoagulants" class="form-checkbox text-blue-500 w-5 h-5">
                                Anticoagulants
                            </label>
                            <label for="asthma_inhalers" class="flex items-center gap-2">
                                <input type="checkbox" id="asthma_inhalers" name="prescribed_medicines[]"
                                    value="Asthma Inhalers" class="form-checkbox text-blue-500 w-5 h-5">
                                Asthma inhalers
                            </label>
                            <label for="baclofen" class="flex items-center gap-2">
                                <input type="checkbox" id="baclofen" name="prescribed_medicines[]" value="Baclofen"
                                    class="form-checkbox text-blue-500 w-5 h-5">
                                Baclofen
                            </label>
                            <label for="carbimazole" class="flex items-center gap-2">
                                <input type="checkbox" id="carbimazole" name="prescribed_medicines[]" value="Carbimazole"
                                    class="form-checkbox text-blue-500 w-5 h-5">
                                Carbimazole
                            </label>
                            <label for="clexane" class="flex items-center gap-2">
                                <input type="checkbox" id="clexane" name="prescribed_medicines[]" value="Clexane"
                                    class="form-checkbox text-blue-500 w-5 h-5">
                                Clexane
                            </label>
                            <label for="domperidone" class="flex items-center gap-2">
                                <input type="checkbox" id="domperidone" name="prescribed_medicines[]" value="Domperidone"
                                    class="form-checkbox text-blue-500 w-5 h-5">
                                Domperidone
                            </label>
                            <label for="ibuprofen" class="flex items-center gap-2">
                                <input type="checkbox" id="ibuprofen" name="prescribed_medicines[]" value="Ibuprofen"
                                    class="form-checkbox text-blue-500 w-5 h-5">
                                Ibuprofen
                            </label>
                            <label for="insulin" class="flex items-center gap-2">
                                <input type="checkbox" id="insulin" name="prescribed_medicines[]" value="Insulin"
                                    class="form-checkbox text-blue-500 w-5 h-5">
                                Insulin
                            </label>
                            <label for="levothyroxine" class="flex items-center gap-2">
                                <input type="checkbox" id="levothyroxine" name="prescribed_medicines[]"
                                    value="Levothyroxine" class="form-checkbox text-blue-500 w-5 h-5">
                                Levothyroxine
                            </label>
                            <label for="mesalazine" class="flex items-center gap-2">
                                <input type="checkbox" id="mesalazine" name="prescribed_medicines[]" value="Mesalazine"
                                    class="form-checkbox text-blue-500 w-5 h-5">
                                Mesalazine
                            </label>
                            <label for="metformin" class="flex items-center gap-2">
                                <input type="checkbox" id="metformin" name="prescribed_medicines[]" value="Metformin"
                                    class="form-checkbox text-blue-500 w-5 h-5">
                                Metformin
                            </label>
                            <label for="omeprazole" class="flex items-center gap-2">
                                <input type="checkbox" id="omeprazole" name="prescribed_medicines[]" value="Omeprazole"
                                    class="form-checkbox text-blue-500 w-5 h-5">
                                Omeprazole
                            </label>
                            <label for="prednisolone" class="flex items-center gap-2">
                                <input type="checkbox" id="prednisolone" name="prescribed_medicines[]" value="Prednisolone"
                                    class="form-checkbox text-blue-500 w-5 h-5">
                                Prednisolone
                            </label>
                            <label for="progesterone" class="flex items-center gap-2">
                                <input type="checkbox" id="progesterone" name="prescribed_medicines[]" value="Progesterone"
                                    class="form-checkbox text-blue-500 w-5 h-5">
                                Progesterone
                            </label>
                            <label for="propothiouracil" class="flex items-center gap-2">
                                <input type="checkbox" id="propothiouracil" name="prescribed_medicines[]"
                                    value="propothiouracil" class="form-checkbox text-blue-500 w-5 h-5">
                                Propothiouracil
                            </label>
                            <label for="sleeping_tablets" class="flex items-center gap-2">
                                <input type="checkbox" id="sleeping_tablets" name="prescribed_medicines[]"
                                    value="Sleeping Tablets" class="form-checkbox text-blue-500 w-5 h-5">
                                Sleeping tablets
                            </label>
                            <label for="steroid_creams" class="flex items-center gap-2">
                                <input type="checkbox" id="steroid_creams" name="prescribed_medicines[]"
                                    value="Steroid Creams" class="form-checkbox text-blue-500 w-5 h-5">
                                Steroid creams
                            </label>
                            <label for="tramadol" class="flex items-center gap-2">
                                <input type="checkbox" id="tramadol" name="prescribed_medicines[]" value="Tramadol"
                                    class="form-checkbox text-blue-500 w-5 h-5">
                                Tramadol
                            </label>
                        </div>
                        <label for="other-medication">If you are using any prescribed medication not in the list above
                            please specify in the field below:</label>
                        <div>
                            <input type="text" id="other-medication" name="other_medication"
                                class="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                    </div>
                        ...
                        <div class="flex gap-4">
                            <label class="flex items-center gap-2">
                                <input type="radio" id="over-counter-medication_yes" name="over-counter-medication"
                                    value="yes" class="form-radio scale-150 text-blue-500"> Yes
                            </label>
                            <label class="flex items-center gap-2">
                                <input type="radio" name="over-counter-medication" id="over-counter-medication_no"
                                    value="no" class="form-radio scale-150 text-blue-500"> No
                            </label>
                        </div>
                    </div>
                    <h2 class="text-[32px] font-inter font-bold text-[#adaaa5] col-span-1 md:col-span-2">Over the counter
                        medicines</h2>
                    <div class="col-span-1 md:col-span-2 flex flex-col gap-2 rounded-lg w-full">
                        ...
                        <label>If you are using any over the counter medication not in the list above please specify in the
                            field below:</label>
                        <div>
                        ...
                        <div>
                            <input type="text" name="other_medicine_specify"
                                class="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                    </div>
                    <div class="flex flex-col col-span-1 md:col-span-2 gap-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <label class="flex items-center gap-2">
                                <input type="radio" id="herbal_medicines_no" name="herbal_medicines" value="no"
                                    class="form-radio scale-150 text-blue-500">
                                No
                            </label>
                        </div>
                    ...
                    <h2 class="text-[32px] font-inter font-bold text-[#adaaa5] col-span-1 md:col-span-2">Herbal medicines
                    </h2>
                    <div class="col-span-1 md:col-span-2 flex flex-col gap-2 rounded-lg w-full">

                        <div class="flex flex-wrap gap-2">
                            <label class="flex items-center gap-2">
                                <input type="checkbox" id="fenugreek" name="herbal_supplements[]" value="Fenugreek"
                                    class="form-checkbox text-blue-500 w-5 h-5">
                                Fenugreek
                            </label>
                            <label class="flex items-center gap-2">
                                <input type="checkbox" id="biloba" name="herbal_supplements[]" value="Biloba"
                                    class="form-checkbox text-blue-500 w-5 h-5">
                                Biloba
                            </label>
                            <label class="flex items-center gap-2">
                                <input type="checkbox" id="st_johns_wort" name="herbal_supplements[]" value="St Johns Wort"
                                    class="form-checkbox text-blue-500 w-5 h-5">
                                St Johns Wort
                            </label>
                        </div>
                        <label>If you are using any herbal medication not in the list above please specify in the field
                            below:</label>
                        <div>
                            <input name="herbal_medication_specify" type="text"
                                class="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                        <label>If yes, please specify what herbal, homeopathic medication or remedies you use</label>
                        <div>
                            <input type="text" name="herbal_medication_other"
                                class="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                    </div>
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <label class="flex items-center gap-2" for="galactogogues_no">
                                <input type="radio" id="galactogogues_no" name="galactogogues" value="No"
                                    class="form-radio scale-150 text-blue-500">
                                No
                            </label>
                        </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <label class="flex items-center gap-2" for="cytotoxic_no">
                                <input type="radio" id="cytotoxic_no" name="cytotoxic_medication" value="No"
                                    class="form-radio scale-150 text-blue-500">
                                No
                            </label>
                        </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <label class="flex items-center gap-2" for="contraceptives_no">
                                <input type="radio" id="contraceptives_no" name="contraceptives" value="No"
                                    class="form-radio scale-150 text-blue-500">
                                No
                            </label>
                        </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <label class="flex items-center gap-2" for="contraceptive_condoms">
                                <input type="checkbox" id="contraceptive_condoms" name="contraceptives_specify[]"
                                    value="Condoms" class="form-checkbox text-blue-500 w-5 h-5">
                                Condoms
                            </label>
                            <label class="flex items-center gap-2" for="contraceptive_injectable">
                                <input type="checkbox" id="contraceptive_injectable" name="contraceptives_specify[]"
                                    value="Injectable" class="form-checkbox text-blue-500 w-5 h-5">
                                Injectable
                            </label>
                            <label class="flex items-center gap-2" for="contraceptive_oral">
                                <input type="checkbox" id="contraceptive_oral" name="contraceptives_specify[]" value="Oral"
                                    class="form-checkbox text-blue-500 w-5 h-5">
                                Oral
                            </label>
                        </div>
                    ...
                    <div class="flex flex-col col-span-1 md:col-span-2 gap-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <label class="flex items-center gap-2" for="monogamous_no">
                                <input type="radio" id="monogamous_no" name="monogamous_relationship" value="No"
                                    class="form-radio scale-150 text-blue-500">
                                No
                            </label>
                        </div>
                    ...
                    {{-- <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <label class="flex items-center gap-2" for="hepatitis_hiv_tb_no">
                                <input type="radio" id="hepatitis_hiv_tb_no" name="hepatitis_hiv_tb" value="No"
                                    class="form-radio scale-150 text-blue-500">
                                No
                            </label>
                        </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <label class="flex items-center gap-2" for="hepatitis_b_no">
                                <input type="radio" id="hepatitis_b_no" name="hepatitis_b" value="No"
                                    class="form-radio scale-150 text-blue-500">
                                No
                            </label>
                        </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <label class="flex items-center gap-2" for="hepatitis_c_no">
                                <input type="radio" id="hepatitis_c_no" name="hepatitis_c" value="No"
                                    class="form-radio scale-150 text-blue-500">
                                No
                            </label>
                        </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <label class="flex items-center gap-2" for="tb_no">
                                <input type="radio" id="tb_no" name="tb_diagnosis" value="No"
                                    class="form-radio scale-150 text-blue-500">
                                No
                            </label>
                        </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <label class="flex items-center gap-2" for="syphilis_no">
                                <input type="radio" id="syphilis_no" name="syphilis_diagnosis" value="No"
                                    class="form-radio scale-150 text-blue-500">
                                No
                            </label>
                        </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            ...
                            <label class="flex items-center gap-2" for="hiv_no">
                                <input type="radio" id="hiv_no" name="hiv_diagnosis" value="No"
                                    class="form-radio scale-150 text-blue-500">
                                No
                            </label>
                        </div>
                    ...
                    {{-- <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            <label class="flex items-center gap-2" for="partner_risk_hiv_yes">
                                <input type="radio" id="partner_risk_hiv_yes" name="partner_risk_hiv" value="Yes"
                                    class="form-radio scale-150 text-blue-500">
                                Yes
                            </label>
                            <label class="flex items-center gap-2" for="partner_risk_hiv_no">
                                <input type="radio" id="partner_risk_hiv_no" name="partner_risk_hiv" value="No"
                                    class="form-radio scale-150 text-blue-500">
                                No
                            </label>
                        </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            <label class="flex items-center gap-2" for="partner_hiv_risk_yes">
                                <input type="radio" id="partner_hiv_risk_yes" name="partner_hiv_risk" value="Yes"
                                    class="form-radio scale-150 text-blue-500">
                                Yes
                            </label>
                            <label class="flex items-center gap-2" for="partner_hiv_risk_no">
                                <input type="radio" id="partner_hiv_risk_no" name="partner_hiv_risk" value="No"
                                    class="form-radio scale-150 text-blue-500">
                                No
                            </label>
                        </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            <label class="flex items-center gap-2" for="partner_drug_use_yes">
                                <input type="radio" id="partner_drug_use_yes" name="partner_drug_use" value="Yes"
                                    class="form-radio scale-150 text-blue-500">
                                Yes
                            </label>
                            <label class="flex items-center gap-2" for="partner_drug_use_no">
                                <input type="radio" id="partner_drug_use_no" name="partner_drug_use" value="No"
                                    class="form-radio scale-150 text-blue-500">
                                No
                            </label>
                        </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            <label class="flex items-center gap-2" for="persistent_cough_exposure_yes">
                                <input type="radio" id="persistent_cough_exposure_yes" name="persistent_cough_exposure"
                                    value="Yes" class="form-radio scale-150 text-blue-500">
                                Yes
                            </label>
                            <label class="flex items-center gap-2" for="persistent_cough_exposure_no">
                                <input type="radio" id="persistent_cough_exposure_no" name="persistent_cough_exposure"
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            <label class="flex items-center gap-2" for="hiv_rapid_test_yes">
                                <input type="radio" id="hiv_rapid_test_yes" name="hiv_rapid_test" value="Yes"
                                    class="form-radio scale-150 text-blue-500">
                                Yes
                            </label>
                            <label class="flex items-center gap-2" for="hiv_rapid_test_no">
                                <input type="radio" id="hiv_rapid_test_no" name="hiv_rapid_test" value="No"
                                    class="form-radio scale-150 text-blue-500">
                                No
                            </label>
                        </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            <label class="flex items-center gap-2" for="breast_pump_yes">
                                <input type="radio" id="breast_pump_yes" name="breast_pump" value="Yes"
                                    class="form-radio scale-150 text-blue-500">
                                Yes
                            </label>
                            <label class="flex items-center gap-2" for="breast_pump_no">
                                <input type="radio" id="breast_pump_no" name="breast_pump" value="No"
                                    class="form-radio scale-150 text-blue-500">
                                No
                            </label>
                        </div>
                        <p class="text-[14px] text-[#adaaa5]">
                            Unfortunately, we are not able to supply breast pumps. Unless you are able to hand express,
                            owning a breast pump is essential.
                        </p>
                    </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            <label class="flex items-center gap-2" for="donor_once">
                                <input type="radio" id="donor_once" name="donor_type" value="Once-off"
                                    class="form-radio scale-150 text-blue-500">
                                Once-off donor
                            </label>
                            <label class="flex items-center gap-2" for="donor_long_term">
                                <input type="radio" id="donor_long_term" name="donor_type" value="Long-term"
                                    class="form-radio scale-150 text-blue-500">
                                Long-term donor
                            </label>
                        </div>
                    ...
                    <div class="flex flex-col gap-3">
                        <label class="block text-gray-600">Please note, SABR reserves the right to outsource the sign up of
                            donors to a third party medical professional.</label>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            <label class="flex items-center gap-2">
                                <input type="radio" name="info_sharing" value="yes"
                                    class="form-radio scale-150 text-blue-500"> Yes
                            </label>
                            <label class="flex items-center gap-2">
                                <input type="radio" name="info_sharing" value="no"
                                    class="form-radio scale-150 text-blue-500"> No
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex gap-4">
                            <label class="flex items-center gap-2">
                                <input type="radio" name="communication_consent" value="yes"
                                    class="form-radio scale-150 text-blue-500"> Yes
                            </label>
                            <label class="flex items-center gap-2">
                                <input type="radio" name="communication_consent" value="no"
                                    class="form-radio scale-150 text-blue-500"> No
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <label class="flex items-center gap-2">
                                <input type="radio" name="communication_method" value="sms"
                                    class="form-radio scale-150 text-blue-500"> SMS
                            </label>
                            <label class="flex items-center gap-2">
                                <input type="radio" name="communication_method" value="email"
                                    class="form-radio scale-150 text-blue-500"> E-mail
                            </label>
                            <label class="flex items-center gap-2">
                                <input type="radio" name="communication_method" value="both"
                                    class="form-radio scale-150 text-blue-500"> Both
                            </label>
                        </div>
                    </div>
    ...
    @push('scripts')
        <script>
            function updateDOB() {
                // Mother DOB
                const day = document.getElementById('mother_dob_day')?.value;
                const month = document.getElementById('mother_dob_month')?.value;
                const year = document.getElementById('mother_dob_year')?.value;
                const dobInput = document.getElementById('mother_date_of_birth');
                ...
                // Baby DOB
                const bDay = document.getElementById('baby_dob_day')?.value;
                const bMonth = document.getElementById('baby_dob_month')?.value;
                const bYear = document.getElementById('baby_dob_year')?.value;
                const babyDobInput = document.getElementById('baby_date_of_birth');
                if (bDay && bMonth && bYear && babyDobInput) {
                    babyDobInput.value = `${bYear}-${bMonth.padStart(2, '0')}-${bDay.padStart(2, '0')}`;
                }
            }
