...
{{-- Add Flasher notifications at the top --}}
@flasher_render

{{-- Keep your existing Laravel session alerts as backup --}}
@if(session('success'))
<div class="mb-4 p-4 text-green-800 bg-green-100 border border-green-300 rounded-lg" role="alert">
